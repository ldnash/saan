...
parseTime(f.origin_departure_time),e=e+("<tr><td style='text-align: center'><p>"+k+"</p></td><td style='text-align: center'><p>"+l+"</p></td><td style='text-align: center'><p>"+f+"</p></td></tr>");g++}d+="</table>";h="<b>Bus Stop: "+a.name+"</b><br>Schedules vary significantly <br><br>"+e+' <p><a target="_blank" href=https://www.google.com/search?q=san%20antonio%20via&btnI>Check VIA Transit for service times and schedules</a></p>'},error:function(){console.log("error getting data")}});return h},styles:{point:{"marker-symbol":"bus"}},
tooltip:"Bus Stop",data:a});transitStops.push(a)},type:"GET",url:"https://transit.land/api/v1/stops.geojson?served_by="+a.features[0].properties.onestop_id})},type:"GET",url:"https://transit.land/api/v1/routes.geojson?operated_by=o-9v1z-viametropolitantransit&gtfs_id="+String(transitRouteNumbers[i])});$.ajax({beforeSend:function(a){a.setRequestHeader("ApiKey","49AB876F-017E-47BE-84BD-876AE6A6151D")},headers:{ApiKey:"49AB876F-017E-47BE-84BD-876AE6A6151D","Cache-Control":"no-cache"},success:function(a){var b=
