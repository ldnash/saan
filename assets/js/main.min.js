...
parseTime(f.origin_departure_time),e=e+("<tr><td style='text-align: center'><p>"+k+"</p></td><td style='text-align: center'><p>"+l+"</p></td><td style='text-align: center'><p>"+f+"</p></td></tr>");g++}d+="</table>";h="<b>Bus Stop: "+a.name+"</b><br>Schedules vary significantly <br><br>"+e+" <p><a href=https://www.google.com/search?q=san%20antonio%20via&btnI>Check VIA Transit for service times and schedules</a></p>"},error:function(){console.log("error getting data")}});return h},styles:{point:{"marker-symbol":"bus"}},
